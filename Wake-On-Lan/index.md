...
When I was a junior, I learned about this and made an example code in Python that receives a list of MACs and a list of IPs and spams all combination possible to the router, project: [WakeOnLan](https://github.com/barakadax/WakeOnLan)
